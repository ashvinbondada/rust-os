...
{ 
    // Cr2 register is set by CPU on a page fault which
    // containes the access virtual address of the page fault.
    // PageFaultErrorCode gives more information about the 
